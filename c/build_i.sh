...
riscv-none-embed-as.exe -march=rv32i -c assem.s -o assem.o
riscv-none-embed-ld.exe -Txriscv.ld -Map=xriscv.map startup.o boot.o stdio.o string.o xuart.o regfile.o  assem.o test.o -lgcc -o xriscv.o -L$RV32I_ILP32
riscv-none-embed-objcopy -O binary xriscv.o xriscv.bin
riscv-none-embed-objdump -d xriscv.o > xriscv_i.lst
